...
-  In the source code but its obfuscated
``` bash
...
- Using a tool like [Js nice](http://jsnice.org/) i get the next output
...
- Finally we need to build up the flag using the logic order 
