...
# Solution
After connecting with the program trough netcat I played a fantasy game where after selecting the ```create a single account option``` and ```play a game```  I followed the instructions until I get the flag.


-  Fantasy Game play trough the terminal 
